...
<body>
    ...
    <section class="book">
        <div class="container flex_space">
            ...
            <div class="form">
                <form id="form_check" class="grid" action="final.php" method="post" target="_self">
                    Check in date
                    ...
                    <input type="submit" value="CHECK AVAILABILITY" class="submit-btn" name="check_availiability">
                </form>
                <?php
    ...
    <section class="counter top" style="background-image: url('background-2.png');">
    ...
    <section id="room" class="rooms" style="height: 750px;" >
    ...
    <section class="gallery" style="margin-top:0px;">
        <div class="container top">
            <div class="heading">
                <h1>PHOTOS</h1>
                <h2>Our Gallery</h2>
    ...
    <section class="Customer top" style="background-image: url('background-1.png'); height: auto;">
        <div class="container">
    ...
    <section class="newsletter mtop">
        <div class="container">
            <div class="news1" style="display:flex; flex-direction:row">
                <h1 style="width:400px">Subscribe to Our Newsletter</h1>
                <form action="final.php" method="post" target="_self">
                    <input type="text" placeholder="Your Email" id="emailInput" name="email" required
                        style="width:450px">
                    <input type="submit" value="Subscribe" id="submitBtn" style="width: 140px;" name="newsletter">
                </form>
            </div>
            <?php
    ...
    <footer>
        <div class="container grid" id="contact">
            ...
            <div class="box">
                <h2>Links</h2>
                <ul>
                    <li><a style="color:#b6b7b9" href="final.php">Home</a></li>
                    <li><a style="color:#b6b7b9" href="#">About Us</a></li>
                    <li><a style="color:#b6b7b9" href="#">News</a></li>
                    <li><a style="color:#b6b7b9" href="#">Contact Us</a></li>
                </ul>
            </div>
