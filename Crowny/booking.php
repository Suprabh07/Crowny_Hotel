...
<body>
    <header>
        <div class="content flex_space navbar">
            ...
            <div class="navlinks">
                <ul id="menulist">
                    <li><a href="final.php" target="_self">home</a> </li>
                    <li><a href="final.php#about" target="_self">about</a> </li>
                    <li><a href="final.php#room" target="_self">rooms</a> </li>
                    <li><a href="final.php#news" target="_self">news</a> </li>
                    <li><a href="final.php#contact" target="_self">contact</a> </li>
                </ul>
        ...
        <div class="form">
            <form action="book_confirm.php" method="post" target="_self">
                ...
                <div class="terms">
                    ...
                    <label for="terms">I confirm that I have read the <a href="#">terms and conditions</a></label>
                </div>
